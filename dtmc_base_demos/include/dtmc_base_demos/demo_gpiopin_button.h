...
typedef struct dtmc_base_demo_gpiopin_button_t dtmc_base_demo_gpiopin_button_t;

// how the demo can be configured
typedef struct dtmc_base_demo_gpiopin_button_config_t
{
    dtgpiopin_handle gpiopin_handle;
} dtmc_base_demo_gpiopin_button_config_t;
...
extern dterr_t*
dtmc_base_demo_gpiopin_button_configure(dtmc_base_demo_gpiopin_button_t* self, dtmc_base_demo_gpiopin_button_config_t* config);
